    ...
    <div className="w-full">
      <section className="reveal-section py-[120px] px-[5%] max-w-[1200px] mx-auto">
        <div className="reveal-content w-full flex flex-col">
          ...
          {/* Row 1 */}
          <div className="story-row flex gap-[80px] items-center mb-[80px] max-lg:flex-col max-lg:gap-10 w-full">
          ...
          {/* Row 2 */}
          <div className="story-row flex flex-row-reverse gap-[80px] items-center max-lg:flex-col max-lg:gap-10 w-full">
            <div className="story-text flex-[1.2]">
              <h3 className="font-serif text-4xl mb-5 text-goldPrimary">
