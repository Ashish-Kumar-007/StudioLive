...
export const Home: React.FC<HomeProps> = ({ onChangePage }) => {
  ...
  return (
    <div className="w-full">
      ...
      <section className="reveal stories-sec-bg py-[120px] px-[5%] relative">
        ...
        <div className="stories-grid grid grid-cols-3 gap-10 max-lg:grid-cols-2 max-md:grid-cols-1 max-w-[1200px] mx-auto">
          {stories.map((story, i) => (
            <div 
              key={i}
              onClick={() => onChangePage('book')}
              className="bg-surfaceDark/65 border border-goldPrimary/12 backdrop-blur-md rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 hover:border-goldPrimary/30 hover:shadow-[0_10px_30px_rgba(0,0,0,0.4)] group"
            >
      ...
      <section className="reveal experience-sec-bg py-[120px] px-[5%] relative">
        <div className="exp-row flex gap-[80px] max-lg:flex-col max-lg:gap-10 max-w-[1200px] mx-auto items-center justify-between">
          ...
          <div className="flex-1 grid grid-cols-2 gap-5 w-full">
            {features.map((feat, i) => (
              ...
              >
                <div className="exp-box-icon">
                  {feat.icon}
                </div>
                <h3 className="exp-box-title">
                  {feat.title}
                </h3>
                <p className="exp-box-desc">
                  {feat.desc}
                </p>
              </div>
            ))}
      ...
      <section className="testimonials-sec py-[120px] px-[5%] bg-surfaceDark/30 relative">
        <div className="text-center mb-[80px] max-w-[1200px] mx-auto">
          <p className="text-xs font-semibold tracking-[0.3em] uppercase text-goldPrimary mb-3">
            Words of Love
          </p>
        ...
        <div className="testi-card max-w-[800px] mx-auto bg-surfaceDark/65 border border-goldPrimary/12 backdrop-blur-md p-[60px] rounded-[30px] text-center relative">
      ...
      {/* CALL TO ACTION (CTA) */}
      <section className="cta-sec cta-sec-bg py-[160px] px-[5%] text-center relative">
